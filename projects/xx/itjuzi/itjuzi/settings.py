...
DEFAULT_REQUEST_HEADERS = {
    'User-Agent': 'User-Agent: Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:61.0) Gecko/20100101 Firefox/61.0',
...
#    'itjuzi.middlewares.ItjuziDownloaderMiddleware': 543,
    #'itjuzi.middlewares.Itjuziproxy':400
}
